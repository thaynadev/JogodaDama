...
def creditos():
	...
	while not sair:
		...
		surface_texto, rect_texto = text_objects("By: Thayna Verissimo", fonte, BRANCO)
		rect_texto.center = ((LARGURA / 2), ALTURA / 3)
		display.blit(surface_texto, rect_texto)

		surface_texto, rect_texto = text_objects("Analise e Desenvolvimento de Sistemas", fonte, BRANCO)
		rect_texto.center = ((LARGURA / 2), ALTURA / 2.7)
		display.blit(surface_texto, rect_texto)

		surface_texto, rect_texto = text_objects("UNIGRANRIO", fonte, AZUL)
		rect_texto.center = ((LARGURA / 2), ALTURA / 1.5)
		display.blit(surface_texto, rect_texto)

		surface_texto, rect_texto = text_objects("A programação transforma vidas", fonte, VERMELHO_CLARO)
...
def regras():
	...
	while not sair:
		...
		info1 = fonte.render(' O jogo de damas e praticado em um tabuleiro de 64 casas.', False, (AZUL))
